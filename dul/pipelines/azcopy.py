...
class cli(pipe):
    ...
    def copy(
        ...
        exclude_blob_type: list[BlobType] = None, exclude_paths: list[str] = None,
        exclude_patterns: list[str] = None, exclude_regex: list[str] = None,
        ...
        include_paths: list[str] = None, include_patterns: list[str] = None,
    ...
    def sync(
        ...
        exclude_attributes: list[str] = None, exclude_paths: list[str] = None,
        exclude_patterns: list[str] = None, exclude_regex: list[str] = None, from_to: str = None,
        include_attributes: list[str] = None, include_patterns: list[str] = None,
    ...
    def remove(
        ...
        include_patterns: list[str] = None, list_of_files: str = None,
