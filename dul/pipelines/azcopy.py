...
def repeat_list(name):
    return once(name)


def repeat_dict(name):
    return lambda k, v: [name, f"{k}={v}"]
...
class cli(pipe):
    def __init__(
        ...
        output_type: OutputLevel = None,
        trusted_microsoft_suffixes: str = None,
        version: bool = None,
        extra_args: list = [],
    ) -> pipe:
        parameters = locals()
        self.schema = Schema(
            {
                ...
                "trusted_microsoft_suffixes": Once(
                    once("--trusted-microsoft-suffixes")
                ),
                ...
                "exclude_paths": Repeat(repeat_list("--exclude-path")),
                "exclude_patterns": Repeat(repeat_list("--exclude-pattern")),
                ...
                "include_paths": Repeat(repeat_list("--include-path")),
                "include_patterns": Repeat(repeat_list("--include-pattern")),
                ...
                "preserve_last_modified_time": Flag(
                    flag("--preserve-last-modified-time")
                ),
                ...
                "s2s_handle_invalid_metadata": Flag(
                    flag("--s2s-handle-invalid-metadata")
                ),
                ...
                "list_of_files": Once(once("--list-of-files")),
                "permanent_delete": Once(once("--permanent-delete")),
            }
        )
        self.cli = ["azcopy"] + self.schema.process(parameters) + extra_args

    def login(
        self,
        aad_endpoint: str = None,
        application_id: str = None,
        certificate_path: str = None,
        identity: bool = None,
        identity_client_id: str = None,
        identity_object_id: str = None,
        identity_resource_id: str = None,
        service_principal: bool = None,
        tenant_id: str = None,
        extra_args: list = [],
    ) -> pipe:
    ...
    def copy(
        ...
        block_blob_tier: BlobTier = None,
        block_size_mb: float = None,
        cache_control: str = None,
        check_length: bool = None,
        check_md5: CheckMD5Type = None,
        content_disposition: str = None,
        content_encoding: str = None,
        content_language: str = None,
        content_type: str = None,
        cpk_by_name: str = None,
        cpk_by_value: str = None,
        decompress: bool = None,
        disable_auto_decoding: bool = None,
        dry_run: bool = None,
        exclude_attributes: list[str] = None,
        exclude_blob_type: list[BlobType] = None,
        exclude_paths: list[str] = None,
        exclude_patterns: list[str] = None,
        exclude_regex: list[str] = None,
        follow_symlinks: bool = None,
        force_if_read_only: bool = None,
        from_to: str = None,
        include_after: str = None,
        include_attributes: list[str] = None,
        include_before: str = None,
        include_directory_stub: bool = None,
        include_paths: list[str] = None,
        include_patterns: list[str] = None,
        include_regex: list[str] = None,
        list_of_versions: str = None,
        metadata: dict = None,
        no_guess_mime_type: bool = None,
        overwrite: OverwriteType = None,
        page_blob_tier: BlobTier = None,
        preserve_last_modified_time: bool = None,
        preserve_owner: bool = None,
        preserve_permissions: bool = None,
        preserve_posix_properties: bool = None,
        preserve_smb_info: bool = None,
        put_md5: bool = None,
        recursive: bool = None,
        s2s_detect_source_changed: bool = None,
        s2s_handle_invalid_metadata: bool = None,
        s2s_preserve_access_tier: bool = None,
        s2s_preserve_blob_tags: bool = None,
        s2s_preserve_properties: bool = None,
        extra_args: list = [],
    ) -> pipe:
    ...
    def remove(
        self,
        destination: str,
        delete_snapshots: SnapshotRemovalType = None,
        dry_run: bool = None,
        exclude_paths: list[str] = None,
        exclude_patterns: list[str] = None,
        force_if_read_only: bool = None,
